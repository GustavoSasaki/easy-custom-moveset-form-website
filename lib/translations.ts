...
export const translations = {
  en: {
    ...
    subtitle: "SM64 Coop Config Generator",
    
    // Hero
    heroTitle: "Create Your Custom Character",
    ...
    optional: "optional",
    autoGenerated: "Auto-generated from abilities",
    ...
    // Instructions
    howToUse: "How to Use",
    instruction1: "Configure your character using the options above",
    instruction2: "Download the generated Lua config file",
    instruction3: "Place the file in your SM64 Coop mods folder",
    instruction4: "Enable the Easy Custom Moveset mod in-game",
    ...
    tooltips: {
      ...
      mrLJump: "Luigi's signature high jump with less air control, from Super Paper Mario.",
      ...
      longJumpTripleJump: "Do a triple jump at the peak of a long jump.",
      ...
      sonicJump: "Higher jump with forward momentum boost.",
      sonicDash: "Charge and release a powerful forward dash.",
      dropDash: "Land from a jump while spinning to immediately gain speed.",
      
      // Twirling
      backFlipTwirling: "Spin during a backflip for slower descent.",
      sideFlipTwirling: "Spin during a sideflip for slower descent.",
      tripleJumpTwirling: "Spin during a triple jump for slower descent.",
      ...
      diveGroundPound: "Transition from dive into ground pound.",
      alwaysDiveFirst: "Always dive instead of attacking when pressing B in air.",
      saultubeJumpAnimation: "Use the spinning pipe launch animation for jumps.",
  ...
  es: {
    // Header
    title: "Easy Custom Moveset",
    subtitle: "Generador de Configs SM64 Coop",
    ...
    inAirJumps: "Saltos en el Aire (0 = apagado)",
    ...
    optional: "opcional",
    autoGenerated: "Auto-generado de habilidades",
    ...
    minForwardSpeed: "Velocidad Minima Frontal",
    maxTime: "Tiempo Maximo",
    ...
    tooltips: {
      ...
      sonicJump: "Salto mas alto con impulso hacia adelante.",
  ...
  pt: {
    // Header
    title: "Easy Custom Moveset",
    subtitle: "Gerador de Configs SM64 Coop",
    ...
    inAirJumps: "Pulos no Ar (0 = desligado)",
    ...
    optional: "opcional",
    autoGenerated: "Auto-gerado das habilidades",
    ...
    minForwardSpeed: "Velocidade Minima Frontal",
    ...
    tooltips: {
      ...
      sonicJump: "Pulo mais alto com impulso para frente.",
